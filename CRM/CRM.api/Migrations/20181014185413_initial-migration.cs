        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Street4 = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganisationActivities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrganisationActivities_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrganisationActivities_AspNetUsers_ModifiedById",
                        column: x => x.ModifiedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrganisationActivities_Organisations_OrganisationId",
                        column: x => x.OrganisationId,
                        principalTable: "Organisations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganisationAddresses", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganisationAppointments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrganisationAppointments_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrganisationAppointments_AspNetUsers_ModifiedById",
                        column: x => x.ModifiedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrganisationAppointments_Organisations_OrganisationId",
                        column: x => x.OrganisationId,
                        principalTable: "Organisations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganisationNotes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrganisationNotes_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrganisationNotes_AspNetUsers_ModifiedById",
                        column: x => x.ModifiedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContactActivities_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ContactActivities_AspNetUsers_ModifiedById",
                        column: x => x.ModifiedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContactAppointments_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ContactAppointments_AspNetUsers_ModifiedById",
                        column: x => x.ModifiedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContactNotes_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ContactNotes_AspNetUsers_ModifiedById",
                        column: x => x.ModifiedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactActivities_CreatedById",
                table: "ContactActivities",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_ContactActivities_ModifiedById",
                table: "ContactActivities",
                column: "ModifiedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactAppointments_CreatedById",
                table: "ContactAppointments",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_ContactAppointments_ModifiedById",
                table: "ContactAppointments",
                column: "ModifiedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactNotes_ModifiedById",
                table: "ContactNotes",
                column: "ModifiedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrganisationActivities_CreatedById",
                table: "OrganisationActivities",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_OrganisationActivities_ModifiedById",
                table: "OrganisationActivities",
                column: "ModifiedById");

            migrationBuilder.CreateIndex(
                name: "IX_OrganisationActivities_OrganisationId",
                table: "OrganisationActivities",
                column: "OrganisationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrganisationAppointments_CreatedById",
                table: "OrganisationAppointments",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_OrganisationAppointments_ModifiedById",
                table: "OrganisationAppointments",
                column: "ModifiedById");

            migrationBuilder.CreateIndex(
                name: "IX_OrganisationAppointments_OrganisationId",
                table: "OrganisationAppointments",
                column: "OrganisationId");

            migrationBuilder.CreateIndex(
                name: "IX_OrganisationNotes_CreatedById",
                table: "OrganisationNotes",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_OrganisationNotes_ModifiedById",
                table: "OrganisationNotes",
                column: "ModifiedById");

            migrationBuilder.CreateIndex(
                name: "IX_OrganisationNotes_OrganisationId",
                table: "OrganisationNotes",
                column: "OrganisationId");
